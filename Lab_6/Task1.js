...
alert("Свойства, которые отличают фигуру \"зеленый круг\"");
...
alert("Свойства, которые описывают фигуру \"треугольник с тремя линиями\"; ")
...
alert("Есть ли у фигуры \"маленький квадрат\" собственное свойство, которое определяет цвет фигуры:");
